...
<link rel="script" href="/static/js/welcome.js">
<style>
...
<div class="w3-top">
    <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
        ...
        <li class="w3-hide-small w3-right"><a href="#" class="w3-padding-large w3-hover-white" title="My Account"><img src="http://cdn.w3schools.wang/img_avatar2.png" class="w3-circle" height="25" width="25" alt="Avatar"></a></li>
    </ul>
</div>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col m3">
            ...
            <div class="w3-card-2 w3-round w3-white">
                <div class="w3-container">
                    ...
                    <p class="w3-center"><img src="http://cdn.w3schools.wang/img_avatar3.png" class="w3-circle" height="106" width="106" alt="Avatar"></p>
                    <hr>
                ...
                <div class="w3-accordion w3-white">
                    ...
                    <div id="Demo3" class="w3-accordion-content w3-container">
                        <div class="w3-row-padding">
                            <br>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_lights.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_nature.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_mountains.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_forest.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_nature.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                            <div class="w3-half">
                                <img src="http://cdn.w3schools.wang/img_fjords.jpg" style="width:100%" class="w3-margin-bottom">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w3-col m7">
            ...
            <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                <img src="http://cdn.w3schools.wang/img_avatar5.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
            ...
            <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                <img src="http://cdn.w3schools.wang/img_avatar6.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
